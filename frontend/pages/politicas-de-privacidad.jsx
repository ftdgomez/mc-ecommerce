...
const politicasdeprivacidad = () => {
	const siteName = ' Refrigeración MC';
	return (
		<MainLayout>
				...
				<main className='container'>
					<div className='bg-white p-8 rounded shadow'>
						...
						<p>
							...
							{siteName} usa y protege la información que es proporcionada por
						...
						<h2 className='subtitle'>Información que es recogida</h2>
						<p>
						...
						<h2 className='subtitle'>Uso de la información recogida</h2>
						<p>
						...
						<p>
							{siteName} pudiera contener en laces a otros sitios que pudieran
							ser de su interés. Una vez que usted de clic en estos enlaces y
							abandone nuestra página, ya no tenemos control sobre al sitio al
							que es redirigido y por lo tanto no somos responsables de los
							términos o privacidad ni de la protección de sus datos en esos
						...
						<h2 className='subtitle'>Control de su información personal</h2>
						<p>
							...
							puede cancelarla en cualquier momento. Esta compañía no venderá,
							cederá ni distribuirá la información personal que es recopilada
							sin su consentimiento, salvo que sea requerido por un juez con un
							orden judicial. {siteName} Se reserva el derecho de cambiar los
